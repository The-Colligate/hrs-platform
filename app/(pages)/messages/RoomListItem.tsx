...
export default function RoomListItem({
  ...
  return (
    <div
      key={room.id}
      className={`flex gap-2 border-l-4 border-white p-4 cursor-pointer rounded-l ${
        active
    ...
    >
      ...
      <div className="grid grid-cols-12">
        <div className="font-semibold flex justify-between items-center col-span-12 gap-1">
        ...
        <div className="max-w-full overflow-hidden flex col-span-12 gap-1">
